...
from src.generation.rag_mistral import RAGResult
...
if __name__ == "__main__":
    from src.generation.rag_mistral import RAGMistralGenerator, RAGResult
    ...
    try:
        ...
        relevant = memory.get_session_memory()
        print(f"\nSession Summary: {relevant}")
