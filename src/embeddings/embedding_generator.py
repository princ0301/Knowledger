...
from src.doc.doc_processor import DocumentProcessor, DocumentChunk
...
class EmbeddingGenerator:
    ...
    def _initialize_model(self):
        try:
            ...
            logger.error(f"Failed to intialize embedding model: {str(e)}")
...
if __name__ == "__main__":
    ...
    try:
        chunks = doc_processor.process_document("D:/Project_new/notebook_lm/data/attn_is_all_you_need.pdf")
