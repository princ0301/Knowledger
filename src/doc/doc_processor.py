...
class DocumentChunk:
    ...
    def get_citation_info(self) -> Dict[str, Any]:
        ...
        if self.start_char or self.end_char:
            citation['chat_range'] = f"{self.start_char}-{self.end_char}"
...
class DocumentProcessor:
    ...
    def process_document(self, file_path: str) -> List[DocumentChunk]:
        ...
        logger.info(f"Processing docuemnt: {file_path.name}")
...
if __name__ == "__main__":
    ...
    try:
        chunks = processor.process_document("D:/Project_new/notebook_lm/data/attn_is_all_you_need.pdf")
